...
/**
 * @coversDefaultClass Kampaw\Dic\Definition\Validator\ParameterValidator
 * @covers ::<!public>
 */
class ParameterValidatorTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var ParameterValidator $validator
     */
    private $validator;
    ...
    public function GetErrors_InvalidParameterType_ReturnsError($parameter)
    {
        ...
        $this->assertContains(ParameterValidator::ARGUMENT_NOT_AN_ARRAY, $errors);
    }
    ...
    public function GetErrors_NameKeyMissing_ReturnsError()
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(ParameterValidator::NAME_KEY_MISSING, $errors);
    }
    ...
    public function GetErrors_NameInvalidType_ReturnsError($name)
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(ParameterValidator::NAME_INVALID_TYPE, $errors);
    }
    ...
    public function GetErrors_NameEmptyString_ReturnsError()
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(ParameterValidator::NAME_EMPTY_STRING, $errors);
    }
    ...
    public function GetErrors_InvalidNameValue_ReturnsError($name)
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(ParameterValidator::NAME_INVALID_VALUE, $errors);
    }
    ...
    public function GetErrors_TypeInvalidType_ReturnsError($type)
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(ParameterValidator::TYPE_INVALID_TYPE, $errors);
    }
    ...
    public function GetErrors_TypeClassNotExists_ReturnsError()
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(ParameterValidator::TYPE_CLASS_NOT_FOUND, $errors);
    }
    ...
    public function GetErrors_RefInvalidType_ReturnsError($ref)
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(ParameterValidator::REF_INVALID_TYPE, $errors);
    }
    ...
    public function GetErrors_ValueInvalidType_ReturnsError()
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(ParameterValidator::VALUE_TYPE_MISMATCH, $errors);
    }
