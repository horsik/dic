...
/**
 * @coversDefaultClass \Kampaw\Dic\Config\Validator\MutatorArrayValidator
 * @covers ::<!public>
 */
class MutatorArrayValidatorTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var MutatorArrayValidator $validator
     */
    private $validator;

    public function setUp()
    {
        $this->validator = new MutatorArrayValidator();
    }
    ...
    public function GetErrors_InvalidParameterType_ReturnsError($mutator)
    {
        ...
        $this->assertContains(MutatorArrayValidator::ARGUMENT_NOT_AN_ARRAY, $errors);
    }
    ...
    public function GetErrors_NameKeyMissing_ReturnsError()
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(MutatorArrayValidator::NAME_KEY_MISSING, $errors);
    }
    ...
    public function GetErrors_NameInvalidType_ReturnsError($name)
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(MutatorArrayValidator::NAME_INVALID_TYPE, $errors);
    }
    ...
    public function GetErrors_NameEmptyString_ReturnsError()
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(MutatorArrayValidator::NAME_EMPTY_STRING, $errors);
    }
    ...
    public function GetErrors_TypeInvalidType_ReturnsError($type)
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(MutatorArrayValidator::TYPE_INVALID_TYPE, $errors);
    }
    ...
    public function GetErrors_TypeClassNotExists_ReturnsError()
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(MutatorArrayValidator::TYPE_CLASS_NOT_FOUND, $errors);
    }
    ...
    public function GetErrors_RefInvalidType_ReturnsError($ref)
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(MutatorArrayValidator::REF_INVALID_TYPE, $errors);
    }
    ...
    public function GetErrors_InvalidRefValue_ReturnsError($name)
    {
        ...
        $this->assertCount(1, $errors);
        $this->assertContains(MutatorArrayValidator::REF_INVALID_VALUE, $errors);
    }
}